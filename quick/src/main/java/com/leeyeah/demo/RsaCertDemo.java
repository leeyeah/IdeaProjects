...
public class RsaCertDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        X500Name x500Name;
        String subject = "CN=sign.rsa.yeah, OU=ASP, O=AisaInfo-Sec, L=beijing, ST=beijing, C=CN";
        ...
        */
        ...
        tmpBytes = ((RSAPrivateKey) privateKey).getPrivateExponent().toByteArray();
        System.out.println(HexStringUtil.bytes2HexStr(tmpBytes));
        ...
        File file = new File("/Users/lee/Desktop/sign.rsa.yeah.csr");
        if (file.exists()) {
            file.delete();
        }
